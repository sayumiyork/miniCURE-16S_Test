...
![](16s-spreadsheets_files/figure-docx//14E26SbzaLEDJxAaZ1qjaZcJehAI8q2GHuTokNPKKDTc_g35f391192_00.png){width=100%}
...
**A Google Sheets cheatsheet that covers the necessary steps for this activity is available.** Students who are not experienced using spreadsheet software should note that the instructions build on prior steps. 
